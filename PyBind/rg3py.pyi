...
class ClassParent:
    ...
    @property
    def class_type(self) -> Optional[CppClass]: ...
...
class CppClass:
    ...
    @property
    def has_copy_constructor(self) -> bool: ...

    @property
    def has_copy_assign_operator(self) -> bool: ...

    @property
    def has_move_constructor(self) -> bool: ...

    @property
    def has_move_assign_operator(self) -> bool: ...
